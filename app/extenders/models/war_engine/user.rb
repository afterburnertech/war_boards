# Override both the setter and getter methods for the forem_admin,
# forem_auto_subscribe and forem_state attributes in the 
# WarEngine::User model
WarEngine::User.class_eval do 
	def forem_settings
